...
export async function POST(req: NextRequest) {
  try {
    ...
    const response = await fetch("https://api.replicate.com/v1/models/black-forest-labs/flux-1.1-pro-ultra/predictions", {
      ...
      body: JSON.stringify({
        input: {
          prompt: "Transform this into a friendly 1980s anime-style illustration inspired by cinematic 80's Japanese cartoons. Use soft watercolor pastel colors, hand-drawn textures, and gentle cel shading. Apply subtle line-work and natural lighting with a warm, nostalgic glow. Emphasize friendly, smiling,expressive, kind-eyed characters, fluid poses, and detailed, whimsical backgrounds. The overall aesthetic should feel cozy, cinematic, and detailed watercolor storybook-like — capturing the charm, warmth, and dreamlike atmosphere of classic Ghibli films from the 80s era.",
